...
* @param source Whether these planes are from the source (or target).
*/
void TransformEstimator::addPlanes(vector<geometry::Plane> planes, bool source)
{
    vector <geometry::Plane> vec;
    for (int i = 0; i < planes.size(); i++)
    {
...
*/
Eigen::Matrix4f TransformEstimator::getTransform()
{
