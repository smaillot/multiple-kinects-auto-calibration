...
// init
    ...
    ros::NodeHandle node_te("/calib/" + name1 + "_" + name2 + "/transform_estimation");
...
// main code
  ...
  Matching match(&node_te, name1, name2);
  matchPtr = &match; 
  dynamic_reconfigure::Server<calib::MatchingConfig> server_matching(node_te);
